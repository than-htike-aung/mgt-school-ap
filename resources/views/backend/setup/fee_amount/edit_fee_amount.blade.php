                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="amount" name="amount[]" value="{{ $edit->amount }}" class="form-control {{ $errors->has('amount') ? ' is-invalid' : '' }}" > <div class="help-block"></div></div>
            ...
            <div class="form-row">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        <h5>Amount<span class="text-danger">*</span></h5>
                        <div class="controls">
                            <input type="text" id="amount" name="amount[]" class="form-control {{ $errors->has('amount') ? ' is-invalid' : '' }}" > <div class="help-block"></div></div>
                            @if ($errors->has('amount'))
                            <span class="text-danger invalid feedback"role="alert">
                                <strong>{{ $errors->first('amount') }}.</strong>
                            </span>
